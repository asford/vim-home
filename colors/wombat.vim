...
hi SignColumn   guifg=#857b6f guibg=#000000 gui=none    ctermfg=101  ctermbg=0    cterm=none
hi SignMark     guifg=#8ac6f2 guibg=#000000 gui=none    ctermfg=105  ctermbg=0    cterm=none
...
" Diff colors
hi DiffAdd      guifg=black guibg=#cae682 ctermfg=black ctermbg=192 cterm=none
hi DiffText     guifg=black guibg=#8ac6f2 ctermfg=black ctermbg=105 cterm=none
hi DiffChange   guifg=black guibg=Grey    ctermfg=black ctermbg=Grey
hi DiffDelete   guifg=black guibg=#e5786d ctermfg=black ctermbg=203 cterm=none
